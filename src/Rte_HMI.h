...
#define Rte_Read_rpSeatCtrlData_DE_Height 				Rte_Read_HMI_rpSeatCtrlData_Height
#define Rte_Read_rpSeatCtrlData_DE_Incline 			Rte_Read_HMI_rpSeatCtrlData_Incline
#define Rte_Read_rpSeatCtrlData_DE_Slide 				Rte_Read_HMI_rpSeatCtrlData_Slide
#define Rte_Read_rpSeatModeBtn_DE_SeatModeBtn			Rte_Read_HMI_rpSeatModeBtn_SeatModeBtn
...
#define Rte_Switch_ppSeatControlMode_SeatCtrlMode		Rte_Switch_HMI_ppSeatCtrlMode_SeatCtrlMode

#define HMI_MainFunction HMI_Mainfunction
